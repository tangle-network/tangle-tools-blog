...
Previous posts covered [why decentralized AI infrastructure matters](https://tangle.tools/post/why-ai-infrastructure-needs-decentralization), [how blueprints work](https://tangle.tools/post/how-blueprints-work), [verification mechanisms](https://tangle.tools/post/how-tangle-verifies-work), [building from idea to production](https://tangle.tools/post/building-on-tangle-from-idea-to-production), and [AI services with inference and sandboxes](https://tangle.tools/post/building-ai-services-on-tangle). This post covers what just shipped: first-class TEE support in the Blueprint SDK.
...
[Blueprint SDK on GitHub](https://github.com/tangle-network/blueprint) · [TEE crate source](https://github.com/tangle-network/blueprint/tree/main/crates/tee) · [Previous: Building AI Services on Tangle](https://tangle.tools/post/building-ai-services-on-tangle)

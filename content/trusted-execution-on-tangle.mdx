...
Previous posts covered [why decentralized AI infrastructure matters](/why-ai-infrastructure-needs-decentralization), [how blueprints work](/how-blueprints-work), [verification mechanisms](/how-tangle-verifies-work), [building from idea to production](/building-on-tangle-from-idea-to-production), and [AI services with inference and sandboxes](/building-ai-services-on-tangle). This post covers what just shipped: first-class TEE support in the Blueprint SDK.
...
<Callout type="warning" title="Never recreate TEE containers">
...
<Callout type="tip" title="Get started with TEE blueprints">
...
[Blueprint SDK on GitHub](https://github.com/tangle-network/blueprint) · [TEE crate source](https://github.com/tangle-network/blueprint/tree/main/crates/tee) · [Previous: Building AI Services on Tangle](/building-ai-services-on-tangle)

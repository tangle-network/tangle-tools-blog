...
summary: "Tangle’s latest runtime upgrade introduces major improvements to prepare the network for growth. Inflation was cut in half to reduce emissions while core products like Tangle Cloud and the Blueprint AI Agent are still in development. Team and investor vesting was extended to four years, identity creation is now cheaper, and execution defaults to WASM for consistency. Vaults can be named, and the multi-asset delegation and services pallet were introduced, laying the groundwork for on-chain service deployment. Points campaigns are launching soon to reward participation on testnet and mainnet."
date: "2025-04-24"
author: "Tangle Team"
tags: ["webflow-migration"]
coverImage: "/images/covers/tangle-upgrade-v1-3-x.svg"
heroImage: "/images/covers/tangle-upgrade-v1-3-x.svg"
imageAlt: "Branded editorial cover for Tangle Upgrade v1.3.X"
---
